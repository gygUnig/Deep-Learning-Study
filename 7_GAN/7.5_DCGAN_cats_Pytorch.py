...
# save model
torch.save(model_D.state_dict(), "./checkpoint/7.6_DCGAN_cats_Pytorch_model_D_v1.pt")
torch.save(model_G.state_dict(), "./checkpoint/7.6_DCGAN_cats_Pytorch_model_G_v1.pt")
