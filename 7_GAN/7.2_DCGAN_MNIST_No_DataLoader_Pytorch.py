...
# save model
torch.save(model_D.state_dict(), "./checkpoint/7.2_DCGAN_MNIST_1_Pytorch_model_D.pt")
torch.save(model_G.state_dict(), "./checkpoint/7.2_DCGAN_MNIST_1_Pytorch_model_G.pt")
